...
$routes->get('/Mantequilla', 'Producto_controller::Mantequilla_Mani');
$routes->get('/Snack', 'Producto_controller::Snack');
$routes->get('/Cafe', 'Producto_controller::Cafe');
$routes->get('/Otros', 'Producto_controller::Otros');
...
$routes->get('comprar', 'Carrito_controller::confirmar_Compra');
